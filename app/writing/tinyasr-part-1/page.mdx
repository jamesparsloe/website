...
date: "2024-01-25"
topics: []
description: "Part 1 of building a tiny speech recognition model from scratch"
draft: false
---
import Image from 'next/image'

export const metadata = { title: 'TinyASR - Part 1', description: 'Part 1 of building a tiny automatic speech recognition model from scratch', alternates: { canonical: '/writing/tinyasr-part-1' } };
