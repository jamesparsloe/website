...
export const metadata = {
    ...
    image: "/project-betty-part-1/architecture.png"
}
...
I'm using the [web search](https://www.anthropic.com/news/web-search-api) in the Anthropic API. Here's my "researcher" prompt:
...
<a 
    href="/project-betty-part-1/results.csv"
    download="project-betty-part-1-results.csv"
>
...
import csvRawData from '!!raw-loader!./results.csv';

export const data = Papa.parse(csvRawData, {
  header: true,
  skipEmptyLines: true,
  dynamicTyping: false
}).data;
